...
export default function OnboardingScreen2() {
  ...
  return (
    <OnboardingPage stepIndex={1}>
      <View style={styles.iconContainer}>
        <Animated.View entering={FadeInDown.delay(200).springify()}>
          <MaterialCommunityIcons name="flash" size={80} color="#fcd34d" />
        </Animated.View>
      </View>
      ...
      <Animated.View entering={FadeInDown.delay(400).springify()} style={styles.textContainer}>
        ...
        <ThemedText style={styles.subtitle}>
          Advanced AI predictions, real-time alerts, and personalized insights at your fingertips.
        </ThemedText>
      </Animated.View>
