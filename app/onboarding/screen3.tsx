...
export default function OnboardingScreen3() {
  ...
  return (
    <OnboardingPage stepIndex={2}>
      <View style={styles.iconContainer}>
        <Animated.View entering={FadeInDown.delay(200).springify()}>
          <MaterialCommunityIcons name="shield-check" size={80} color="#4ade80" />
        </Animated.View>
      </View>
      ...
      <Animated.View entering={FadeInDown.delay(400).springify()} style={styles.textContainer}>
        ...
        <ThemedText style={styles.subtitle}>
          Your data is secure. We ask for permissions only to enhance your local experience.
        </ThemedText>
      </Animated.View>
